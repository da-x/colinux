...
extern co_rc_t co_os_daemon_peek_messages(co_daemon_handle_t handle, bool_t *available);
extern co_rc_t co_os_daemon_get_message(co_daemon_handle_t handle, co_message_t **message);
